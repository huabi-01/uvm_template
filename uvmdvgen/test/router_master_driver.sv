`ifndef  router_master_driver
`define router_master_driver
    class router_master_driver extends uvm_driver#(router_transaction);
        `uvm_component_utils(router_master_driver)
        
        virtual  vif;

        function new(string name = "router_master_driver",uvm_component parent);
